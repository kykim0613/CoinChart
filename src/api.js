...
export const upbitListAPI = async () => {
    const response = await fetch(`${ip}/api/upbit/markets`)
...
export const binanceListAPI = async () => {
    const response = await fetch(`${ip}/api/binance/markets`)
    const data = await response.json()
    return data
}

export const upbitCandlesAPI = async (market, start, end) => {
    const response = await fetch(`${ip}/api/upbit/candles?market=KRW-${market}&start=${start}&end=${end}`)
    const data = await response.json()
...
export const binanceCandlesAPI = async (market, start, end) => {
    const response = await fetch(`${ip}/api/binance/candles?market=${market}USDT&start=${start}&end=${end}`)
    const data = await response.json()
